...
const DICT = {
  ...
  voiceCommands: { en: 'Voice', pt: 'Voz' },
  cmdNext: { en: 'next slide', pt: 'diapositivo seguinte' },
  cmdPrev: { en: 'previous slide', pt: 'diapositivo anterior' },
  cmdFirst: { en: 'first slide', pt: 'primeiro diapositivo' },
  cmdLast: { en: 'last slide', pt: 'último diapositivo' },
  cmdGoto: { en: 'slide by number', pt: 'diapositivo por número' },
  cmdOverview: { en: 'all slides at once', pt: 'todos os diapositivos de uma vez' },
  cmdOpen: { en: 'open a presentation', pt: 'abrir uma apresentação' },
  cmdClose: { en: 'close the presentation', pt: 'fechar a apresentação' },
  cmdReadIn: { en: 'switch the reading language', pt: 'mudar o idioma de leitura' },
  cmdMicLang: { en: 'microphone recognition language', pt: 'idioma de reconhecimento do microfone' },
  cmdRoomLang: { en: 'room recognition language', pt: 'idioma de reconhecimento da sala' },
  voiceLangNote: {
    en: 'Say them in the language the microphone is set to — a pinned recogniser cannot hear another one.',
    pt: 'Diga-os no idioma para que o microfone está definido — um reconhecedor fixo não consegue ouvir outro.',
  },
